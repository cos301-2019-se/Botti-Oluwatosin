...
import type { User } from 'react-native-google-signin';
        ...
        export default class LoginView extends Component<{}, State> {
          ...
          renderUserInfo(userInfo) {
            return (
              <View style={styles.container}>
                ...
                <Button onPress={() => this._signInAsync(userInfo)} title="Set" />
          ...
          _signInAsync = async (userInfo) => {
            try{

            
            await AsyncStorage.setItem('@userToken', userInfo.user.name);
            } catch(e) {
              // save error
              console.log(e);
            }
            ...
            if(value !== null) {
                console.log("User Token has been set", value );
